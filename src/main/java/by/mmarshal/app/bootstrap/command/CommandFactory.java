...
public class CommandFactory {
    ...
    static {
        ...
        COMMAND_LIST.put(CommandsEnum.ITEM_COMMAND.getCommand(), new ItemPageCommandImpl());
        COMMAND_LIST.put(CommandsEnum.CATEGORIES_COMMAND.getCommand(), new CategoriesPage());
        COMMAND_LIST.put(CommandsEnum.CART.getCommand(), new CartCommandImpl());
        COMMAND_LIST.put(CommandsEnum.PRODUCT_INFO.getCommand(), new ProductInfoCommandImpl());
        COMMAND_LIST.put(CommandsEnum.DELETE_PRODUCT_IN_CARD.getCommand(), new DeleteProductInCardCommandImpl());
        COMMAND_LIST.put(CommandsEnum.REGISTRATION.getCommand(), new RegistrationCommandImpl());
        COMMAND_LIST.put(CommandsEnum.SEARCH.getCommand(), new SearchCommandImpl());
        COMMAND_LIST.put(CommandsEnum.FILTER.getCommand(), new FilterCommandImpl());
    }
    ...
    public static BaseCommand defineCommand(HttpServletRequest request) {
        ...
        if(commandKey == null || commandKey.isEmpty()){
            commandKey = CommandsEnum.HOME_PAGE_COMMAND.getCommand();
        }
